...
echo "$nl* \`implementation 'com.kaltura.playkit:broadpeakplugin:$NEW_VERSION"\'\` >> $RELEASE_NOTES
echo "$nl [Broadpeak Sample](https://github.com/kaltura/kaltura-player-android-samples/tree/master/AdvancedSamples/Broadpeak)" >> $RELEASE_NOTES
